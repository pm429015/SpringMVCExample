	...
	<div class="container">
			...
			<div class="col-xs-12">
				<div id="photo-header" class="text-center">
					...
					<div id="text-header">
						...
						<h5><a href="https://copy.com/7uT0ydLwkd1mXZhi">Download My Resume</a></h5>
					</div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-7">
				...
				<div class="box">
					<h2>About Me</h2>
					<h4>&nbsp;&nbsp;&nbsp;&nbsp;A results-oriented software engineer with extensive DARPA and start-up
						experiences throughout software development life cycle,
						from identifying requirements to software design and debugging.
					</h4>
					<h4>&nbsp;&nbsp;&nbsp;&nbsp;Background encompasses hand-on experience in programming, Machine Learning and
						Data Mining, OOP, GUI and designing novel algorithms for complex
						problems. Excellent programming and team collaboration skills.
					...
					<ul id="education" class="clearfix">
						<li>
							...
							<div class="description pull-right">
								...
								<h5>Like to share my secret resources with you!<br>
									<a href="http://pm429015.wordpress.com/2014/11/03/my-learning-resources/">Check Out My Self Learning Resources</a>
								</h5>
							</div>
						</li>
						...
						<li>
							...
							<div class="description pull-right">
								<h3>M.S. Electrical and Computer Engineering, Iowa State University</h3>
								<h5>GPA: 3.78 / 4.0<br>
									Thesis Published in IT Professional Magazine: <br><a href="http://icas.public.iastate.edu/06545274.pdf">Capturing Cognitive Fingerprints from Keystroke Dynamics</a>
								</h5>
							</div>
						</li>
						<li>
							...
							<div class="description pull-right">
								<h3>B.S. Information Management, Shih Hsin University, Taiwan</h3>
								<h5>GPA: 3.4 / 4.0</h5>
							</div>
						</li>
					...
					<div class="job clearfix">
						...
						<div class="col-xs-8">
							...
							<div class="description">
								<li>Primary developer for a novel RESTful data mining web service MSS-Sunergo prototype for both back-end and front-end technology like Java Spring MVC, HTML, Javascript, etc.</li>
								<li>Pioneered the move into a new security framework <a href="http://www.cs.cornell.edu/projects/fabric/">Fabric</a> and collaborated with Cornell University.</li>
								<li>Designed a system architecture that is able to access realtime10 TB+ text data like patents and papers.</li>
								<li>Documented and maintained reports of all coding and presented them to tech/non-tech clients.</li>
							</div>
						</div>
					</div>
					<div class="job clearfix">
						<div class="col-xs-4">
							<div class="where">Defense Advanced Research Projects Agency (DARPA)</div>
						...
						<div class="col-xs-8">
							...
							<div class="description">
								<li>Developed a scalable web-based active authentication application from scratch. 
								This system has been reported on news like <a href="http://www.cnet.com/news/one-way-to-make-passwords-obsolete-just-keep-typing/">CNET</a>, <a href="http://usatoday30.usatoday.com/tech/news/story/2012-06-11/keystroke-id-analysis/55525698/1">USA Today</a> and more.</li>
								<li>Implemented a web service that integrates machine learning SVM libraries and self-developed algorithms achieving approximate 98% accuracy.</li>
								<li>Maintained the reliability of the computationally intensive services and database for 2000+ user’s requests.</li>
								<li>Discovered important human biometrics features from a large-scale human keystroke behavior dataset.</li>
								<li>Co-wrote a technical report and published in <a href="http://icas.public.iastate.edu/06545274.pdf">IT Professional Magazine.</a> </li>
								<li>Helped our team to enter the second phase of DARPA, which resulted in 5.2 million dollars in funding.</li>
							</div>
						</div>
					</div>
					<div class="job clearfix">
						...
						<div class="col-xs-8">
							...
							<div class="description">
								<li>Inspired, motivated and incentivized a team of talented professionals.</li>
								<li>Planned and Prioritized to ensure missions deadlines are met.</li>
								<li>Followed company commander guidelines and instructions and adapted promptly to management directional changes.</li>
							</div>
						</div>
					</div>
				...
				<div class="box">
					...
					<div class="skills">
						...
						<div class="item-skills" data-percent="0.60"
							style="overflow: hidden; width: 33.30318929561605px;">Design Pattern</div>
						<div class="item-skills" data-percent="0.60"
						...
						<div class="item-skills" data-percent="0.65"
							style="overflow: hidden; width: 25.769513008268724px;">Machine Learning</div>
						...
						<div class="item-skills" data-percent="0.8"
							style="overflow: hidden; width: 23.88609393643189px;">Spring MVC</div>
...
<!-- 							<div class="title">Journal Publications</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-md-3 reduce-padding"> -->
<!-- 							<div class="number">34</div> -->
<!-- 							<div class="title">Conference Presentations &amp; Papers</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-md-3 reduce-padding"> -->
<!-- 							<div class="number">4.73/5</div> -->
<!-- 							<div class="title">Average Teaching Rating</div> -->
<!-- 						</div> -->
<!-- 						<div class="col-md-3 reduce-padding"> -->
...
<!-- 								<div style="width: 100%; overflow: hidden; height: 14px;" -->
<!-- 									class="icons-red"></div> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="skill"> -->
<!-- 							Crowdsourcing -->
<!-- 							<div class="icons pull-right"> -->
<!-- 								<div style="width: 80%; overflow: hidden; height: 14px;" -->
<!-- 									class="icons-red"></div> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="skill"> -->
<!-- 							Cybersecurity -->
<!-- 							<div class="icons pull-right"> -->
<!-- 								<div style="width: 60%; overflow: hidden; height: 14px;" -->
<!-- 									class="icons-red"></div> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="skill"> -->
